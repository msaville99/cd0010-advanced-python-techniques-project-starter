...
class NearEarthObject:
    ...
    def __init__(self, **info):
        ...
        self.hazardous = True if info['hazardous'].lower() == 'y' else False
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname!s} has a diameter of {self.diameter:.3f} km, " \
               f"and is {'not ' if not self.hazardous else ''}potentially hazardous ({self.hazardous})."
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"At {self.time_str}, PDES {self._designation} NEO approaches Earth at a distance of {self.distance:.2f} au and a velocity of {self.velocity:.2f} km/s."
